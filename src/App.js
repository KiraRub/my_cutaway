        ...
        <Wrapper>
            ...
            <Container>
                ...
                <MiddleContent>
                    ...
                    <Text>
                        Меня зовут Кирилл, я — Backend-разработчик с более чем двухлетним опытом работы. В профессиональной сфере я стремлюсь, что-то улучшить или разработать, что помгает оптимизировать и ускорить бизнес-процессы. Вне работы я увлекаюсь настольными играми и читаю литературу в жанре "экономический роман", что мотивирует развиваться в аналитическом и экономическом мышление. Также я ценю здоровый образ жизни: регулярно занимаюсь в тренажерном зале, поскольку считаю важным развиваться всесторонне, сочетать физические и интеллектуальные навыки.
                    </Text>
                    <Description>Опыт:</Description>
                    <Text>
                        2 года backend разработки за время которых были интегрированы внешние платежные системы метода b2b и bank transfer, доработана админская часть multiaccounts (для вылавливания недобросовестных пользователей с множественными аккаунтами), сервис cron-scheduler для проверки и свободной установки времени выполнения регламентных заданий без внесения доработок. Оптимизировал пользовательские запросы и наладил систему фильтров.
                    </Text>
